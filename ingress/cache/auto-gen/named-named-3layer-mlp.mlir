...
// Linalg on tensors, named ops (matmul, add, max)
...
module {
  func.func @entry(%arg0: tensor<256x1024xf32>, %arg1: tensor<1024x2048xf32>, %arg2: tensor<2048xf32>, %arg3: tensor<256x2048xf32>, %arg4: tensor<2048x4096xf32>, %arg5: tensor<4096xf32>, %arg6: tensor<256x4096xf32>, %arg7: tensor<4096x512xf32>, %arg8: tensor<512xf32>, %arg9: tensor<256x512xf32>) -> tensor<256x512xf32> {
    %0 = linalg.matmul ins(%arg0, %arg1 : tensor<256x1024xf32>, tensor<1024x2048xf32>) outs(%arg3 : tensor<256x2048xf32>) -> tensor<256x2048xf32>
    ...
    %6 = linalg.matmul ins(%5, %arg4 : tensor<256x2048xf32>, tensor<2048x4096xf32>) outs(%arg6 : tensor<256x4096xf32>) -> tensor<256x4096xf32>
    ...
    %12 = linalg.matmul ins(%11, %arg7 : tensor<256x4096xf32>, tensor<4096x512xf32>) outs(%arg9 : tensor<256x512xf32>) -> tensor<256x512xf32>
